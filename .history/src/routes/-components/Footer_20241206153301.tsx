...
export const Footer = () => {
  return (
    <div className="relative flex flex-col items-center gap-4 border border-red-400 p-4 md:gap-10 lg:m-24 lg:flex-row lg:p-[100px] lg:pl-[10%]">
      <div className="border-blue-700 lg:w-1/2 lg:flex-col lg:gap-6">
        ...
        <div className="mt-5 flex flex-col gap-2 md:flex-row md:justify-around lg:justify-between">
          <Link
            to="/auth/signup"
            search={{ returnTo: "/dashboard" }}
            className="btn bg-brand-green-6 px-4 py-2 text-white md:w-[40%] lg:w-auto"
          >
            Join Colabs for free
          </Link>
          <Link
            to="/dashboard/hackathons"
            className="btn px-4 py-2 text-brand-green-7 outline outline-1 outline-brand-green-5 md:w-[40%] lg:w-auto"
          >
