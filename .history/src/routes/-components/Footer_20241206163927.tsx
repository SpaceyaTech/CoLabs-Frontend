...
export const Footer = () => {
  return (
    <div className="flex flex-col gap-4 p-4 md:gap-10 lg:relative lg:flex-row lg:p-[100px] lg:pl-[20%]">
      ...
      <img
        src={robot}
        alt="Standing robot"
        className="mt-4 pl-[30%] md:mt-4 md:w-[50%] md:pl-[15%] lg:z-10"
      />
      <img
        src={ellipse}
        alt="ellipse background"
        className="hidden lg:absolute lg:bottom-0 lg:top-10 lg:block"
      />
    </div>
  );
};
