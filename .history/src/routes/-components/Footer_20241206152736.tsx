...
export const Footer = () => {
  return (
    <div className="relative flex flex-col items-center gap-4 border border-red-400 p-4 md:gap-10 lg:flex-row lg:p-[100px] lg:pl-[10%] lg:m-24">
      <div className="border-blue-700 lg:w-1/2 lg:flex-col">
