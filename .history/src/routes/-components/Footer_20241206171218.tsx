...
export const Footer = () => {
  return (
    <div className="relative flex flex-col items-center gap-4 p-4 md:gap-10 lg:flex lg:flex-row lg:p-[100px] lg:pl-[20%]">
      <div className="lg:flex lg:w-1/2 lg:flex-col lg:gap-6">
      ...
      <img
        src={robot}
        alt="Standing robot"
        className="z-10 mt-4 pl-[30%] md:mt-4 md:w-[50%] md:pl-[15%] lg:w-auto"
      />
      <img
        src={ellipse}
        alt="ellipse background"
        className="absolute bottom-[-20%] right-0 top-10 z-0"
      />
      {/* lg:bottom-0 lg:top-10 lg:-z-10 lg:translate-y-[30%] */}
    </div>
  );
};
